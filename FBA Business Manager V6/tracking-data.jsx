...
function trkApplyParsed(s, parsed) {
  ...
  if (parsed.cargoNo) patch.scac = patch.scac;
  if (parsed.etaDate) {
...
Object.assign(window, {
  ...
  trkFmt, trkAgo, trkLoad, trkPatch, trkInfo, trkStage, trkEvents, trkStatus,
  trkAdvance, trkSyncNow, trkParseForwarderMessage, trkApplyParsed,
});
