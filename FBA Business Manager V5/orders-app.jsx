...
// ----------------------------------------------------------------------
function OrdersTable({ orders, onOpenOrder, emptyFiltered, onClearFilter, onNewOrder }) {
  if (!orders.length) {
        ...
        {orders.map((order) => (
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
              <div>
                <span className="vy-mono" style={{ fontSize: 11, color: "hsl(var(--muted-fg))", display: "block" }}>
                  {order.id}
                </span>
      ...
      <div className="vy-app-main">
        ...
        <main className="vy-content">
          <div className="vy-content-inner">
            ...
            {/* Orders table */}
            <OrdersTable
              orders={statusFilter === "All statuses" ? orders : orders.filter((o) => (o.status || "") === statusFilter)}
