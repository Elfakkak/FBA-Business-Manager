...
function VyEditOrderDrawer({ open, onClose }) {
  ...
  const [placed, setPlaced] = useOeState(O.placedOn && O.placedOn !== "—" ? O.placedOn : "");
  const [eta, setEta] = useOeState(O.fbaEta && O.fbaEta !== "—" ? O.fbaEta : "");
  ...
  function save() {
    ...
    if (typeof ordSaveEdits === "function") {
      ordSaveEdits(id, {
        ...
        placedOn: placed.trim() || undefined,
        fbaEta: eta.trim() || undefined,
      });
    }
