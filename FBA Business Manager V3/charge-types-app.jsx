...
function ChargeTypesPage() {
  ...
  const kpis = [
    { icon: "receipt", label: "Charge types", value: String(active.length), sub: "in the vocabulary" },
  ...
  return (
    <div className="vy-app">
      <VySidebar collapsed={sidebarCollapsed} onToggleCollapsed={() => setSidebarCollapsed(!sidebarCollapsed)} onNavigate={() => setMobileNavOpen(false)} active="Charge types" />
          ...
          <div className="vy-content-inner">
            ...
            <div className="vy-card vy-page-head-card">
              <div className="vy-page-head-main">
                ...
                <h1 className="vy-page-title" style={{ fontSize: 24, margin: "6px 0 0", fontWeight: 600 }}>Charge types</h1>
      ...
      <VyMobileNav open={mobileNavOpen} onClose={() => setMobileNavOpen(false)} active="Charge types" />
